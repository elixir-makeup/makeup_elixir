...
schism "variables and atoms" do
  dogma "split" do
    # Generated from lib/makeup/lexers/elixir_lexer/atoms_start.ex.exs, do not edit.
    # Generated at 2020-10-02 11:22:39Z.
    ...
    defmodule Makeup.Lexers.ElixirLexer.AtomsStart do
      ...
      def atom_start_chars__0(
          ...
          when (x0 >= 65 and x0 <= 90) or x0 === 95 or (x0 >= 97 and x0 <= 122) or x0 === 170 or
                 x0 === 181 or x0 === 186 or (x0 >= 192 and x0 <= 214) or
                 (x0 >= 216 and x0 <= 246) or
                 (x0 >= 248 and x0 <= 705) or (x0 >= 710 and x0 <= 721) or
                 (x0 >= 736 and x0 <= 740) or
                 x0 === 748 or x0 === 750 or (x0 >= 880 and x0 <= 884) or
                 (x0 >= 886 and x0 <= 887) or
                 (x0 >= 890 and x0 <= 893) or x0 === 895 or x0 === 902 or
                 (x0 >= 904 and x0 <= 906) or
